    ...
    if (isLoading) {
        return (
            <div className="text-center h-[calc(100vh-64px-34px)] flex items-center justify-center gap-3">
                <svg aria-hidden="true" className="w-12 h-12 text-gray-200 animate-spin fill-[var(--dark-light-brown)]" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
